...
final class SkillModel {
    ...
    var name: String
    var summary: String            // short description (for selection)
    
    // Split skill into two parts (important)
    var systemPart: String         // stable behavior
    var contextPart: String        // detailed instructions/examples
    
    var priority: Int              // higher = more important
    var isEnabled: Bool
    
    // simple keyword matching (you can upgrade later)
    var triggers: [String]
    ...
    init(
        ...
        self.systemPart = systemPart
        self.contextPart = contextPart
